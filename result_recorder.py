...
class Recorder:
     def __init__(self, file_name):
        ...
        self.file.write("input file, output file, width, height, framerate, profile, bitrate(kb/s), psnr(db), real bitrate(kb/s)\n")
     ...
     def record(self, h264_file_name, yuv_file_name, file_prop, enc_param, enc_result) :
       ...
       self.file.write("%s, %s" % (enc_result['psnr'], enc_result['real_bitrate']))
       self.file.write("\n")
